...
class Subnet(Core):
    def __init__(self, url, session, id=None, ipsec_enable=None, network_prefix=None, subnet_id=None, tunnel_ip_type=None,
                 tunnel_switch_domain_id=None, tunnel_switch=None, tunnel_switch_id=None, tunnel_switch_iface=None,
                 tunnel_switch_domain=None,
                 tunnel_switch_name=None, subnet=None, **kwargs):
        self.id = id
        self.url = url
        ...
        self.tunnel_switch_domain = tunnel_switch_domain
        ...
        self.tunnel_switch_iface = tunnel_switch_iface
    ...
    def _make_json(self):
        ...
        {
            'ipsec_enable': True,
            'network_prefix': '54.241.0.0/16', 
            'subnet_id': '1', 
            'tunnel_ip_type': 1, 
            'tunnel_switch_domain_id': '5', 
            'tunnel_switch_id': None, 
            'tunnel_switch_iface': None, 
            'tunnel_switch_name': 'aws-dev-3'
        }
        """
        data = self.to_dict()
        if "id" in data.keys():
    ...
    def update_subnet(self):
        ...
        if not self.id:
            ...
            raise SubnetError()
        subnet_json = self._make_json()
        update_url = url = self._get_subnet_url() + "/" + str(self.id)
    ...
    def delete_subnet(self):
        subnet_id = self.subnet_id              # Zone ID
